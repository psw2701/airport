			...
			<div class="box">
				...
				<div class="box-footer">
					<div class="text-center">
                        ...
                        <li><a href="${pageContext.request.contextPath}/board/myBoard?page=${pageMaker.startPage-1}&searchType=${cri.searchType}&keyword=${cri.keyword}">&laquo;</a></li>
                     </c:if>                     
                     <c:forEach var="idx" begin="${pageMaker.startPage }" end="${pageMaker.endPage }">
                        <li ${pageMaker.cri.page == idx ? 'class="active"':''}><a href="${pageContext.request.contextPath}/board/myBoard?page=${ idx}&searchType=${cri.searchType}&keyword=${cri.keyword}">${ idx}</a></li> 
                     </c:forEach>
                     <c:if test="${pageMaker.next }">
                        <li><a href="${pageContext.request.contextPath}/board/myBoard?page=${pageMaker.endPage+1}&searchType=${cri.searchType}&keyword=${cri.keyword}">&raquo;</a></li>
                     </c:if>   
						</ul>
					</div>
				</div>
	...
	<script>
		$(function () {
			$("#btnSearch").click(function(){
				...
				location.href = "${pageContext.request.contextPath}/board/myBoard?searchType="+searchType+"&keyword="+keyword;
			})
